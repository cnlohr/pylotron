/* Default linker script, for normal executables ... Tweaked by C. Lohr to make them smaller. */
...
*/
  ...
  . = DATA_SEGMENT_ALIGN (16, 8); /*(CONSTANT (MAXPAGESIZE), CONSTANT (COMMONPAGESIZE));*/
